...
body {
    ...
    .intro {
      ...
      width: 100%;
      height: 520px;
      background: linear-gradient(to bottom, rgba(0, 0, 0, 0.5) 0%, rgba(0, 0, 0, 0.5) 100%), url("https://images.pexels.com/photos/1029606/pexels-photo-1029606.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2");
...
<body>
    ...
    <main>
        <div class="intro">
            ...
            <p> Admin Access</p>
            <a href="viewemployee.jsp"><button>Employee</button></a>
        </div>
        ...
        <div class="about-me">
            ...
            <img src="https://images.pexels.com/photos/4427908/pexels-photo-4427908.jpeg?auto=compress&cs=tinysrgb&w=600">
        </div>
    </main>
    <footer class="footer">
